...
abstract class AbstractService extends BaseAbstractService implements ServiceInterface
{
    ...
    public function getAuthorizationUri(array $additionalParameters = array())
    {
        ...
        //temporary fix for redirect uri
        if(array_key_exists('redirect_uri', $additionalParameters))
        {
            $parameters['redirect_uri'] = $additionalParameters['redirect_uri'];
        }
        $parameters['scope'] = implode(' ', $this->scopes);
        //temporary fix for scope
        if(array_key_exists('scope', $additionalParameters))
        {
            $parameters['scope'] = implode(' ', $additionalParameters['scope']);
        }
